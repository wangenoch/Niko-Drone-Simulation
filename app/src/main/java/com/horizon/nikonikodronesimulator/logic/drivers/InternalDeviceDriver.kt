package com.horizon.nikonikodronesimulator.logic.drivers
...
interface InternalDeviceDriver {
    ...
    // [v1.7.6] 預設映射策略
    fun getDefaultMapping(mode: Int, key: String): com.horizon.nikonikodronesimulator.model.ChannelMapping = com.horizon.nikonikodronesimulator.model.ChannelMapping()
}
