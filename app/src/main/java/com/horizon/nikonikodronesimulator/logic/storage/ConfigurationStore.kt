package com.horizon.nikonikodronesimulator.logic.storage

import android.content.Context
import android.content.SharedPreferences
import android.content.pm.PackageManager
import com.horizon.nikonikodronesimulator.logic.DeviceProfileManager
...
class ConfigurationStore(private val context: Context) {
    ...
    fun loadModelSettings(droneId: String, state: DroneState) {
        val modelPrefs = context.getSharedPreferences("model_settings_$droneId", Context.MODE_PRIVATE)
        val module = com.horizon.nikonikodronesimulator.model.DroneRegistry.getModule(droneId)
