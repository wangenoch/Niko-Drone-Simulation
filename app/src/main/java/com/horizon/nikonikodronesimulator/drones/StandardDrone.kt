...
object StandardDrone : DroneModule {
    ...
    override val geometry = listOf(
        ...
        listOf(
            com.horizon.nikonikodronesimulator.model.DronePart(tx = p[0]/2, ty = 0f, tz = p[1]/2, w = 0.08f, h = 0.04f, d = 0.7f, color = floatArrayOf(0.18f, 0.18f, 0.18f, 1f), ry = 45f * side),
            com.horizon.nikonikodronesimulator.model.DronePart(tx = p[0], ty = 0.05f, tz = p[1], w = 0.16f, h = 0.16f, d = 0.16f, color = floatArrayOf(p[2], p[3], p[4], 1f)),
            com.horizon.nikonikodronesimulator.model.DronePart(tx = p[0], ty = 0.12f, tz = p[1], w = 0.65f, h = 0.01f, d = 0.05f, color = floatArrayOf(0.95f, 0.95f, 0.95f, 0.6f), isPropeller = true, rotationDirection = side, baseRpm = 2000f),
            com.horizon.nikonikodronesimulator.model.DronePart(tx = p[0], ty = 0.12f, tz = p[1], w = 0.05f, h = 0.01f, d = 0.65f, color = floatArrayOf(0.95f, 0.95f, 0.95f, 0.6f), isPropeller = true, rotationDirection = side, baseRpm = 2000f)
        )
    }
