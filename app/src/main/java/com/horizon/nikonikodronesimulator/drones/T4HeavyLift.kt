...
object T4HeavyLift : DroneModule {
    ...
    override val geometry = listOf(
        ...
        com.horizon.nikonikodronesimulator.model.DronePart(tx = 0f, ty = 0.15f, tz = 0f, w = 0.4f, h = 0.12f, d = 0.4f, color = floatArrayOf(0.1f, 0.1f, 0.1f, 1f)),
        com.horizon.nikonikodronesimulator.model.DronePart(tx = 0f, ty = 0.1f, tz = -0.3f, w = 0.05f, h = 0.05f, d = 0.05f, color = floatArrayOf(0f, 1f, 0f, 1f)),
        com.horizon.nikonikodronesimulator.model.DronePart(tx = 0f, ty = 0.25f, tz = 0f, w = 0.25f, h = 0.12f, d = 0.25f, color = floatArrayOf(0f, 0.3f, 0.8f, 1f))
    ) + listOf(-0.12f, 0.12f).map { ax ->
        com.horizon.nikonikodronesimulator.model.DronePart(tx = ax, ty = 0.35f, tz = -0.18f, w = 0.012f, h = 0.3f, d = 0.012f, color = floatArrayOf(0.15f, 0.15f, 0.15f, 1f), rx = -15f)
    } + run {
        val armLen = 0.8f
        listOf(floatArrayOf(1f,1f), floatArrayOf(-1f,1f), floatArrayOf(1f,-1f), floatArrayOf(-1f,-1f)).flatMap { p ->
            val side = p[0] * p[1]
            listOf(
                com.horizon.nikonikodronesimulator.model.DronePart(tx = p[0]*armLen/2*0.707f, ty = 0.15f, tz = p[1]*armLen/2*0.707f, w = armLen, h = 0.04f, d = 0.04f, color = floatArrayOf(0.05f, 0.05f, 0.05f, 1f), ry = -45f * side),
                com.horizon.nikonikodronesimulator.model.DronePart(tx = p[0]*armLen*0.707f, ty = 0.15f, tz = p[1]*armLen*0.707f, w = 0.12f, h = 0.08f, d = 0.12f, color = floatArrayOf(0.1f, 0.1f, 0.1f, 1f)),
                com.horizon.nikonikodronesimulator.model.DronePart(tx = p[0]*armLen*0.707f, ty = 0.11f, tz = p[1]*armLen*0.707f, w = 0.14f, h = 0.03f, d = 0.14f, color = if(p[1] > 0) floatArrayOf(0f, 1f, 0f, 1f) else floatArrayOf(1f, 0f, 0f, 1f)),
                com.horizon.nikonikodronesimulator.model.DronePart(tx = p[0]*armLen*0.707f, ty = 0.2f, tz = p[1]*armLen*0.707f, w = 0.7f, h = 0.01f, d = 0.04f, color = floatArrayOf(0.9f, 0.9f, 0.9f, 0.5f), isPropeller = true, rotationDirection = side, baseRpm = 2500f)
            )
        }
    } + listOf(floatArrayOf(0.25f, 0.2f), floatArrayOf(-0.25f, 0.2f), floatArrayOf(0.25f, -0.2f), floatArrayOf(-0.25f, -0.2f)).map { l ->
        com.horizon.nikonikodronesimulator.model.DronePart(tx = l[0], ty = -0.2f, tz = l[1], w = 0.03f, h = 0.5f, d = 0.03f, color = floatArrayOf(0.1f, 0.1f, 0.1f, 1f))
        ...
        listOf(
            com.horizon.nikonikodronesimulator.model.DronePart(tx = lx, ty = -0.45f, tz = 0f, w = 0.04f, h = 0.04f, d = 0.9f, color = skidColor),
            com.horizon.nikonikodronesimulator.model.DronePart(tx = lx, ty = -0.45f, tz = 0.5f, w = 0.05f, h = 0.05f, d = 0.15f, color = skidColor),
            com.horizon.nikonikodronesimulator.model.DronePart(tx = lx, ty = -0.45f, tz = -0.5f, w = 0.05f, h = 0.05f, d = 0.15f, color = skidColor)
        )
    }
    ...
    override fun RenderIcon(modifier: androidx.compose.ui.Modifier, isSelected: Boolean) {
        com.horizon.nikonikodronesimulator.ui.settings.HeavyLiftIcon(modifier)
    }

    override val physicsDamping: Float get() = 0.98f
    override val brakingInertiaScale: Float = 3.4f // [v1.7.21] 重型機具備明顯動能慣性，增加滑行距離

    // [v1.7.33] 重型機動力基因重組：確保能克服 15kg 的模擬重力
    override val physicsPower: Float get() = 48.0f
    override val physicsMass: Float get() = 1.5f
