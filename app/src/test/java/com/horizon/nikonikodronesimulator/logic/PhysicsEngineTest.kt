...
class PhysicsEngineTest {
    ...
    fun testWindDriftPolarity() {
        ...
        val eastWindAtmos = atmos.copy(
            windLevel = 4, 
            windDirection = com.horizon.nikonikodronesimulator.model.AppConfig.WIND_DIR_E
        )
        ...
        val northWindAtmos = atmos.copy(
            windLevel = 4, 
            windDirection = com.horizon.nikonikodronesimulator.model.AppConfig.WIND_DIR_N
        )
