...
import com.horizon.nikonikodronesimulator.model.CommDecisionState
import java.io.File
...
class InternalCommManager(
    ...
    private var activeDriver: com.horizon.nikonikodronesimulator.logic.drivers.InternalDeviceDriver? = null
    ...
    fun exportDiagnosticReport(context: Context) {
        ...
        com.horizon.nikonikodronesimulator.util.LogExporter.exportDiagnosticLog(context, droneState, physicalLog, { droneState.systemMessage = it }, { droneState.systemMessage = it })
    }
                ...
                if (u == 0xA6) { 
                    if (i + 5 <= assemblyPos) {
                        ...
                        if (i + len <= assemblyPos) { 
                            ...
                            if (activeDriver == null) activeDriver = if (isV2) com.horizon.nikonikodronesimulator.logic.drivers.AX12V2Driver() else com.horizon.nikonikodronesimulator.logic.drivers.AX12Driver()
